...
const START_IMAGE =
  "https://images.unsplash.com/photo-1591990348263-9f9154d568b6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60";
const END_IMAGE =
  "https://images.unsplash.com/photo-1471899236350-e3016bf1e69e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1051&q=80";
const FORM_IMAGES = [
...
const form = {
  ...
  validTo: new Date(2030, 11, 25, 20, 30, 0), // 2030 Aug(7 + 1) 1st 8:30:00 pm
  visible: true,
  start: {
    session: "start",
  ...
  items: [
    ...
    },
    {
      ...
      title: "Email",
      description:
        "We'll need your email for sending you a copy of this submission.",
...
function saveDataToSheet(data) {
  ...
  if (now < validFrom || now > validTo) {
    return `<p>Sorry, the form is currently unavailable.<\/p>`;
  }

  if (counts >= form.maxResponses && form.maxResponses) {
    return `<p>Sorry, you've reached the maximum allowed responses.<\/p>`;
  }
  ...
  ws.appendRow(values);
  const message =
    `<p>Thanks for you submission, here is your unique id <b>${uuid}<\/b> of the submisssion.<\/p>`;
  return message;
}
